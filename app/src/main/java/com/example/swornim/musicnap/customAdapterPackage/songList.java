...
public class songList {
    ...
    private List<songList> songs=new ArrayList<songList>();
    private String songName;
    private String songAbsoutePath;

    public String getSongAbsoutePath() {
        return songAbsoutePath;
    }

    public void setSongAbsoutePath(String songAbsoutePath) {
        this.songAbsoutePath = songAbsoutePath;
    }
